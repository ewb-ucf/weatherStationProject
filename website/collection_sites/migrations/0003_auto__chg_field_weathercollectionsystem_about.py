...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'collection_sites_weathercollectionsystem', 'about', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'WeatherCollectionSystem.about'
        db.alter_column(u'collection_sites_weathercollectionsystem', 'about', self.gf('django.db.models.fields.CharField')(default=0, max_length=500))
